...
void BinaryHeader::set_desc(void)
{
    ...
    INTERVAL_MS.description = "Sample interval in microseconds (?s). Mandatory for all data types.";
    INTERVAL_MS_ORI.description = "Sample interval in microseconds (?s) of original field recording.";
